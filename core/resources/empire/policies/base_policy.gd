...
enum Modifier { EXPLORER_LOS_BONUS, MONEY_TO_STABILITY, RESEARCH_EVENT_CHANCE, RELIGIOUS_BUILDING_STABILITY_BONUS, FACTORY_PRODUCTION_BONUS, PROGRESSION_BONUS_POINTS, SPECIALIZATION_BONUS_PCT, STABILITY_PENALTY, GENERAL_CHANCE, EXPLORER_CHANCE, ENGINEER_CHANCE, PROPHET_CHANCE }
